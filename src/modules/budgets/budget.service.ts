...
//     return { data, message: 'Budget created successfully', statusCode: 201 };
//   }
...
//     return { data, message: 'Budget updated successfully', statusCode: 200 };
//   }
...
//     const data = await this.budgetRepository.findOne({ where: { userId, budgetId } });
...
//     return { data: null, message: 'Budget deleted successfully', statusCode: 200 };
//   }
// }
